...
public class Exercise1Test extends ClassicOnlineStore {
    ...
    public void findRichCustomers() {
        ...
        /*
        //DoubleCalculater doubleCalculater = x -> x*2;
        DoubleCalculater doubleCalculater = x -> {
            return x * 2;
        };

        System.out.println(doubleCalculater.calculate(2));
    ...
    public void howOldAreTheCustomers() {
         ...
         */
        Function<Customer, Integer> getAgeFunction = Customer::getAge; //c->c.getAge();
