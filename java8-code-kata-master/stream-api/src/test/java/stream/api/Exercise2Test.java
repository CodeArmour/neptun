...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Stream<Integer> sortedAgeStream = customerList.stream().map(Customer::getAge).peek(System.out::println).sorted((c1,c2)->c1.compareTo(c2)).peek(System.out::println);
    ...
    public void top3RichCustomer() {
        ...
        Stream<String> top3RichCustomerStream = customerList.stream()
                .sorted((c1,c2)->c2.getBudget().compareTo(c1.getBudget())).limit(3)
                .map(Customer::getName/*c->c.getName()*/).peek(System.out::println);
